...
VAULT_TOKEN=$(curl     --request POST     --data '{"role": "strongdm", "jwt": "'$JWT'", "subscription_id":"'$SUBSCRIPTION_ID'", "resource_group_name":"'$RG'", "vm_name":"'$vm_name'"}'     http://${vault_ip}:8200/v1/auth/azure/login | jq -r .auth.client_token)
